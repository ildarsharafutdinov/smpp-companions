 ...
 * {@code SmppFrame.MAX_COMMAND_LENGTH} (in the {@code framer} package) is the AD-30 cap referenced by
 * the framer (Story 1.2) and — from Story 1.3 — by the relay direct-memory formula and the config default.
 */
