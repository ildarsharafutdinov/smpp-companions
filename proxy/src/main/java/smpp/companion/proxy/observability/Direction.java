...
/**
 * The leg of a coupled ingress&harr;egress pair a {@link SpliceObserver} event is observed on (AD-27).
 ...
 * {@link SpliceObserver} seam carries no channel or identity label (AD-19 cardinality bound).
 */
