...
- Authority-provider outage blocks new binds — ongoing splices survive (adjudication is bind-time only; no provider state is cached) *(re-worded 2026-08-27, Story 3.4 T2 — the "survive on cached JWKS" clause died with the cache)*. (A-2).
