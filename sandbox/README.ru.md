...
> **Статус:** оригинал написан в рамках задач T1+T2+T3 Story 6.3 (2026-09-17); русский перевод —
...
> 2026-09-17. Оставшаяся задача: **T4** — закрытие доказательства/каталог/леджер; перевод
