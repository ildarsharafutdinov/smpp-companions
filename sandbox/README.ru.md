...
> **Статус:** оригинал написан в рамках задач T1–T4 Story 6.3 (2026-09-17); русский перевод —
...
> машинно исполнен с этой страницы), T3 — сценарии проверки корректности с ожидаемыми наблюдениями
> на каждом плече (§6) и гид по отладке (§7), оба исполнены вживую с этой страницы на стенде
> 2026-09-17. T4 (того же числа) — закрытие: инертность к Gradle проверена живым прогоном
...
> (E2E-002..005), `epic-6-context.md` регенерирован по факту; перевод
> обновляется вслед за оригиналом · **Аудитория:**
